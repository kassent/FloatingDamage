...
public:
	//void			** vtbl; //02D27530
	DEFINE_MEMBER_FUNCTION(GetCrosshairRefHandle, UInt32 *, 0x09DDC70, UInt32& refHandle); // called by readyweaponhandler::processbuttonevent. //48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 48 8D 59 60 48 8B F9 48 8B F2 48 8B CB E8 ? ? ? ? 48 8B CF E8 ? ? ? ? 8B 08 89 0E 48 85 DB
};
...
public:
	...
	DEFINE_MEMBER_FUNCTION(UpdateElements, void, 0xAB1850, BSFixedString &); //called by updatecomponents; //48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 81 EC ? ? ? ? 48 8B EA 48 8B F1
	DEFINE_MEMBER_FUNCTION(ClearElements, void, 0xAB1AB0); //called by updatecomponents; //40 53 48 81 EC ? ? ? ? 48 8B D9 48 8D 91 ? ? ? ?
};
...
public:
	...
	DEFINE_MEMBER_FUNCTION(PickUpItem, void, 0xA921D0); //48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 50 48 8B F9 48 8D 54 24 ?
};
